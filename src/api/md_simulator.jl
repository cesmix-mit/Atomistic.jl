...
"""
    simulate(system::AbstractSystem{3}, simulator::MolecularDynamicsSimulator, potential::ArbitraryPotential)::MolecularDynamicsResult
...
"""
simulate(system::AbstractSystem{3}, simulator::MolecularDynamicsSimulator, potential::ArbitraryPotential) = throw(UnimplementedError(:simulate, simulator))
